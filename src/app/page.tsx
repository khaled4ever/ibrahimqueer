    ...
    <section className="relative w-full h-[calc(100vh-5rem)] flex items-center justify-center">
      ...
      <div className="relative text-center text-white p-4 z-10">
        ...
        <p className="mt-4 text-lg md:text-xl max-w-3xl mx-auto">
          الجودة والخبرة التي تستحقها سيارتك في الرياض. نقدم خدمات شاملة من
          الميكانيكا والكهرباء إلى البرمجة والسمكرة بأعلى جودة.
        </p>
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 max-w-2xl mx-auto text-lg text-muted-foreground">
            نقدم حلولاً شاملة لسيارتك بأيدي خبراء وباستخدام أحدث التقنيات.
          </p>
        </div>
